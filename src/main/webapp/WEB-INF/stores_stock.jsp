                ...
                <div class="container-fluid">
                    ...
                    <form action="Stock" method ="POST">
                        <div class="row">                           
                            <div class="col-6">
                                <div class="mb-3">
                                  	<label for="store" class="form-label">Lista de depósitos</label>
                        ...
                        <div class="row">
                            <div class="col-2 text-left">
                                <div class="mb-3">
                                    <input type="submit" value="Buscar" class="form-control bg-warning text-gray-100" id="submit" name="action">
                                </div>
                            </div>
                        </div>
                    </form>
