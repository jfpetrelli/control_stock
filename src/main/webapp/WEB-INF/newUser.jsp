					...
					<form action = "NewUser" method = "POST">
					  <div class="form-group">
						<label for="nameUser">Nombre</label>
							<input type="text" class="form-control" name="name" aria-describedby="textHelp" placeholder="Ej: Juan" required>
						<label for="lastnameUser">Apellido</label>
							<input type="text" class="form-control" name="lastname" aria-describedby="textHelp" placeholder="Ej: Perez" required>
						...
						<label for="usernameUser">Usuario</label>
							<input type="text" class="form-control" name="username" aria-describedby="textHelp" placeholder="Ej: jperez48" required>
						<label for="passwordUser">Contraseña</label>
							<input type="text" class="form-control" name="password" aria-describedby="textHelp" placeholder="Ej: Asd123" required>
						<label for="rolUser">Rol</label>
							<select class="form-control" aria-label="Default select example" id="rol_id" name="rol_id">
                                  		<% for (Roles rol : roles) {%>
									  		<option 
									  			value= "<%=rol.getId() %>"
												selected= "<%=rol.getType()%>"
									  		><%=rol.getType() %></option>
									  	<% } %>
							</select>
					  	</div>
