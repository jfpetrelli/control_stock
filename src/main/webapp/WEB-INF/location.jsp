                            ...
                            <div class="col-12">
                            	<h4>Nueva localidad:</h4>
								  ...
								  <div class="form-group">
								    ...
								    <input disabled required class="form-control" name="city" value="<%= location.getCity() %>">
								  <div class="form-group">
								    <label for="state">Provincia</label>
								    <input disabled  required class="form-control" name="state" value="<%= location.getState() %>">
								  </div>	
								  <div class="form-group">
								    <label for="cp">CP</label>
								    <input disabled  required class="form-control" name="cp" value="<%= location.getZipcode() %>">
								  </div>									  
